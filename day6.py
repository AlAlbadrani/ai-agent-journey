...
def get_weather(city):
    ...
    return f"{coords['name']}, {coords['country']}: {weather['temperature']}°C, wind {weather['windspeed']} km/h"
...
def run_agent(user_message):
    ...
    while True:
        response = client.messages.create(
                ...
                max_tokens=1024,
                system="You are Claude, a helpful AI assistant with memory and access to tools. You have been provided with the history of previous conversations with this user." \
                " Use this history to personalize your responses and remember details about the user.",
                tools=tools,
...
if conversation_history:
    print(f"Welcome back! I remember our last {len(conversation_history)//2 } exchanges. \n")
else:
...
while True:
    ...
    if user_input.lower() == "quit":
        print(f"You had {len(conversation_history) // 2} exchanges total. Goodbye!")
        break
